...
static int	ft_case_two(t_meta_data *meta)
{
...
static int	ft_case_three(t_meta_data *meta)
{
	int			max;
...
static int	ft_case_four(t_meta_data *meta)
{
	int			min;
	int			rst;
	int			max;
...
static int	ft_case_five(t_meta_data *meta)
{
	int			min;
	int			i;
